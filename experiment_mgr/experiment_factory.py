...
def get_all_to_run():
    ...
    builder_classes = [eb.MaxSoftmaxRunBuilder, eb.ODINRunBuilder, eb.DropoutRunBuilder, eb.ConfidenceRunBuilder, eb.EntropyRunBuilder]
    ...
    datasets = [("ood", eb.sun_experiment_set), ("ood", eb.normal_experiment_set), ("ood", eb.uniform_experiment_set)]
