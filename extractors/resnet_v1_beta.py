...
def bottleneck(inputs,
  ...
  """
  #####TODO:WARNING WARNING HACK HACK INCOMING WATCH OUT!!!!!
  is_training_dropout = True
  #####HACK:Droput is only used for mc dropout uncertainty so this is always
  #####set to true 
  with tf.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
    ...
    if dropout == True:
        output = slim.dropout(output, keep_prob=keep_prob,
...
def resnet_v1_beta_block(scope, base_depth, num_units, stride, dropout = False, num_drop = 4):
...
def resnet_v1_50_beta(inputs,
  ...
  blocks = [
      resnet_v1_beta_block(
          'block1', base_depth=64/filter_scale, num_units=3, stride=2),
      resnet_v1_beta_block(
          'block2', base_depth=128/filter_scale, num_units=4, stride=2),
      resnet_v1_beta_block(
          'block3', base_depth=256/filter_scale, num_units=6, stride=2, dropout = True, num_drop = 4),
      resnet_v1_beta_block(
          'block4', base_depth=512/filter_scale, num_units=3, stride=2),
  ]
...
def resnet_v1_101_beta(inputs,
  ...
  blocks = [
      ...
      resnet_v1_beta_block(
          'block2', base_depth=128/filter_scale, num_units=4, stride=2),
      resnet_v1_beta_block(
          'block3', base_depth=256/filter_scale, num_units=23, stride=2, dropout = True, num_drop = 4),
      resnet_v1_beta_block(
          'block4', base_depth=512/filter_scale, num_units=3, stride=2),
  ]
  return resnet_v1_beta(
